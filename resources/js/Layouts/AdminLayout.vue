        ...
        <aside
            ...
            <div>
                <div class="px-6 py-4 -mx-6">
                    ...
                    <h1 class="text-xl text-center"><span class="text-pink-600"> {{ $page.props.auth.user.name }} </span>
                    </h1>
                    </Link>
                </div>
                <ul class="mt-8 space-y-2 tracking-wide">
                    <template v-if="hasRole('admin')">
                        ...
                        <li>
                            <SidebarLink :href="route('tags.index')" aria-label="dashboard"
                                ...
                                <span class="-mr-1 font-medium">Tags</span>
                            </SidebarLink>
                        </li>
                        <li>
                    ...
                    <li v-if="hasRole('moderator')">
                        <SidebarLink :href="route('admin.index')" aria-label="dashboard"
                        ...
                        <SidebarLink :href="route('aduan.index')" aria-label="dashboard"
                            :active="route().current('aduan.index')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li v-if="hasRole('user')">
                        ...
                        <SidebarLink :href="route('aduan.user')" aria-label="dashboard"
                            :active="route().current('aduan.user')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M3 3v1.5M3 21v-6m0 0l2.77-.693a9 9 0 016.208.682l.108.054a9 9 0 006.086.71l3.114-.732a48.524 48.524 0 01-.005-10.499l-3.11.732a9 9 0 01-6.085-.711l-.108-.054a9 9 0 00-6.208-.682L3 4.5M3 15V4.5" />
        ...
        <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
            <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
                <div class="flex items-center justify-between px-6 space-x-4 2xl:container">
                    <h5 hidden class="text-2xl font-medium text-gray-600 lg:block"><span
                            class="text-pink-600">Lapor</span><span class="text-black">Kab!</span></h5>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <button aria-label="chat"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-5 h-5 m-auto text-gray-600">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                        </button>
                        </Link>
                        <Link :href="route('footer.edit')">
                        <button aria-label="chat"
                            class="w-10 h-10 bg-gray-100 border rounded-xl focus:bg-gray-100 active:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-5 h-5 m-auto text-gray-600">
