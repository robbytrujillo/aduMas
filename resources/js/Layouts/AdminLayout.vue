        ...
        <aside class="">
                    ...
                    <Link href="/" title="home">
                        <h1 class="">
                            <span class="text-pink-600">
                                {{ $page.props.auth.UserActivation.name }}</span
                            >
                        </h1>
                    </Link>
                </div>
            ...
            >
                ...
                >
                    ...
                    <span class="text-pink-600 group-hover:text-black"
                        >Logout</span
                    >
                </Link>
            </div>
        ...
        <div class="ml-auto mb-6 lg:w[75%] xl:w-[80%] 2xl:w-[85%]">
            <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
                ...
                >
                    ...
                    >
                        <span class="text-pink-600">Lapor</span
                        ><span class="text-black">Kab!</span>
                    </h5>
