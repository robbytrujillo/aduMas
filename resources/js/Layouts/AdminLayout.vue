            ...
            <div>
                ...
                <ul class="mt-8 space-y-2 tracking-wide">
                    <template v-if="hasRole('admin')">
                        ...
                        <li>
                            <SidebarLink :href="route('tags.index')" aria-label="dashboard" :active="route().current('tags.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <SidebarLink :href="route('posts.index')" aria-label="dashboard" :active="route().current(posts.index)">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <SidebarLink :href="route('users.index')" aria-label="dashboard" :active="route().current('users.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <SidebarLink :href="route('roles.index')" aria-label="dashboard" :active="route().current('roles.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <SidebarLink :href="route('permissions.index')" aria-label="dashboard" :active="route().current('permissions.index')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <SidebarLink :href="route('categories.index')" aria-label="dashboard" :active="route().current('categories.index')">
                                ...
                                <span class="-nr-1 font-medium">Categories</span>
                            </SidebarLink>
                        </li>
                    </template>
